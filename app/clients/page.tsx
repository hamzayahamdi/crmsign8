...
export default function ClientsPage() {
  ...
  const totalRevenue = clients.reduce((sum, client) => sum + (((client as any).budget as number) || 0), 0)
                    ...
                    {(client as any).budget && (
                      <div className="mt-4 pt-4 border-t border-border/40">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-lg font-semibold text-white">{formatCurrency((client as any).budget)}</span>
                        </div>
                      </div>
                    )}
