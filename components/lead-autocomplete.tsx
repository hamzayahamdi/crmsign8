    ...
    <div ref={containerRef} className={cn("relative w-full isolate", isOpen && "z-[110]", className)}>
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-10 md:pl-12 pr-10 h-12 md:h-14 bg-slate-700/60 border-slate-500/50 text-white placeholder:text-slate-400 rounded-lg md:rounded-xl text-sm md:text-base focus:border-primary focus:ring-2 focus:ring-primary/20"
        />
        {searchQuery && (
          <button
            onClick={handleClear}
                  ...
                  {filteredLeads.map((lead, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-3 mt-1">
                            <span className="flex items-center gap-1 text-[10px] md:text-xs text-slate-300">
                          ...
                          {lead.typeBien && (
                            <span className="inline-block mt-1 px-2 py-0.5 bg-blue-600/20 text-blue-300 text-[10px] md:text-xs rounded-full">
                              {lead.typeBien}
                            </span>
                          )}
                        </div>
