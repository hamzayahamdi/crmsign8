                  ...
                  {opportunities.length > 0 ? (
                    <>
                      ...
                      {opportunityCounts.lost > 0 && (
                        <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-red-500/20 text-red-300 border border-red-500/40 text-[10px] font-semibold shadow-sm">
                          ❌ {opportunityCounts.lost} Perdu{opportunityCounts.lost > 1 ? 's' : ''}
                        </span>
                      )}
                    </>
                  ) : (
                      ...
                      <div className="flex items-center justify-center gap-1 flex-wrap">
                        {opportunities.length > 0 ? (
                          <>
                            ...
                            {opportunityCounts.lost > 0 && (
                              <span className="inline-flex items-center px-1.5 py-0.5 rounded-md bg-red-500/20 text-red-300 border border-red-500/40 text-[9px] font-semibold shadow-sm">
                                ❌ {opportunityCounts.lost} Perdu{opportunityCounts.lost > 1 ? 's' : ''}
                              </span>
                            )}
                          </>
