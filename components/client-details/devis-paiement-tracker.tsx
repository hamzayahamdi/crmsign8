...
export function DevisPaiementTracker({
  client,
  onUpdate,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-[#171B22] rounded-xl border border-white/10 p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-sm font-semibold text-white/80">💳 Paiements</h3>
        ...
        {paymentsList.length > 0 ? (
          ...
          <div className="text-center py-6">
            ...
            <p className="text-xs text-white/40">Aucun paiement enregistré</p>
